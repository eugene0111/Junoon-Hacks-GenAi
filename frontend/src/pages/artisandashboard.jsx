...
const ArtisanDashboardPage = () => {
  ...
  const featureCards = [
    ...
    { title: 'Grants & Investors', description: 'Find funding for your ideas.', icon: <GiftIcon />, imageUrl: 'https://placehold.co/400x200/F0FFF0/0F9D58?text=Funding&font=roboto&ts=28', link: '#' },
