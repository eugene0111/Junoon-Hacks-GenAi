...
const ArtisanDashboardPage = () => {
  ...
  const featureCards = [
      ...
      { title: 'Submit a New Idea', description: 'Get feedback from the community.', icon: <LightBulbIcon />, imageUrl: 'https://placehold.co/400x200/FEF7E0/F4B400?text=New+Idea&ts=28', link: '/artisan/ideas/new' },
        ...
        <div>
            ...
            <AnimatedSection>
                ...
                {statsData.map((stat, index) => ( 
                    ...
                    <a key={index} href={stat.link} className="cursor-pointer"><StatCard stat={stat} /></a>
                ))}
                </div>
            </AnimatedSection>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <AnimatedSection className="lg:col-span-2">
                    <div className="relative bg-gradient-yellow-deep text-white p-8 rounded-2xl shadow-xl flex flex-col md:flex-row items-center justify-between h-full transform hover:scale-[1.02] transition-transform duration-300 overflow-hidden">
                        <div className="absolute -bottom-10 -right-10 w-40 h-40 text-black/10">
                        <GiftIcon/>
                        </div>
                        <div className="relative z-10">
                ...
                <AnimatedSection>
                    <div className="relative bg-gradient-blue-light text-white p-8 rounded-2xl shadow-xl flex flex-col items-center justify-center text-center h-full transform hover:scale-[1.02] transition-transform duration-300 overflow-hidden">
                        <div className="absolute -top-8 -left-8 w-32 h-32 text-black/10">
                        <MicIcon/>
                        </div>
                        <div className="relative z-10 flex flex-col items-center">
                        <div className="p-4 rounded-full bg-white/20 pulsate mb-3">
                            <MicIcon />
                        </div>
