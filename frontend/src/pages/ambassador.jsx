    ...
    return (
        ...
        >
            ...
            >
                ...
                <div className="p-8">
                    <h3 className="text-2xl font-bold text-gray-800 mb-2">Join as an <span className="text-google-yellow">Ambassador</span></h3>
                    <p className="text-gray-500 mb-6">We're excited to have you. Let's get you started.</p>
                    <form onSubmit={handleSubmit} className="space-y-4">
                        ...
                        <textarea name="skills" rows="2" value={formData.skills} onChange={handleInputChange} className="block w-full px-3 py-3 bg-gray-100 border-2 border-transparent rounded-lg text-gray-800 focus:outline-none focus:border-google-yellow transition-colors resize-none" placeholder="Relevant skills or experience?"></textarea>
                        
                        <button type="submit" className="w-full bg-google-yellow text-white font-bold px-10 py-3 rounded-full hover:opacity-90 transition-all duration-300 transform hover:scale-105 shadow-lg">
                            Submit Application
                        </button>
                    </form>
                </div>
...
              </div>
              <div className="bg-white p-6 rounded-lg shadow-md">
          _highlightText<h3 className="font-bold text-xl mb-2 text-google-red">Champion Local Craft</h3>
